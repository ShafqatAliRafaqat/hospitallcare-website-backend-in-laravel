...
@section('title', 'Edit | CareALL Pass Categories')
@section('styles')
    ...
    <div class="row">
      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('pass_categories.update',$category->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                        ...
                        class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ $category->name }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" value="{{ $category->amount }}" required>
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('treatments') ? 'is-invalid' : '' }}" value="{{ $category->treatments }}" required>
                ...
                <label class="col-md-2 form-control-label">Diagnostics</label>
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('diagnostics') ? 'is-invalid' : '' }}" value="{{ $category->diagnostics }}" required>
