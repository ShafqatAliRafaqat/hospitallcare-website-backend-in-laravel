            ...
            <form class="form-horizontal" method="post" action="{{ route('vlogs.update',$vlogs->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" value="{{ $vlogs->meta_title }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" value="{{ $vlogs->meta_description }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" value="{{ $vlogs->url }}" required>
                    @if($errors->has('url'))
