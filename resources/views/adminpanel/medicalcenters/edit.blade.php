              ...
              <div id="dynamic_field">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                      ...
                      class="form-control {{ $errors->has('meta_heading') ? 'is-invalid' : '' }}" value="{{ $center->meta_heading }}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        class="form-control {{ $errors->has('image_alt') ? 'is-invalid' : '' }}" value="{{ $center->image_alt }}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea placeholder="Enter Details" class="form-control tiny" name="article" id="" cols="30" rows="5">{{ $center->article }}</textarea>
